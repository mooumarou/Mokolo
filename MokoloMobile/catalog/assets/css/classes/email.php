 ...
 */
    ...
    function add_text($text = '') {
      $this->text = mm_convert_linefeeds(array("\r\n", "\n", "\r"), $this->lf, $text);
    }
 ...
 */
    ...
    function add_html($html, $text = NULL, $images_dir = NULL) {
      $this->html = mm_convert_linefeeds(array("\r\n", "\n", "\r"), '<br />', $html);
      $this->html_text = mm_convert_linefeeds(array("\r\n", "\n", "\r"), $this->lf, $text);
...
//    function build_message($params = array()) {
    function build_message($params = '') {
      ...
      if (mm_not_null($this->html_images)) {
      ...
      $null = NULL;
      $attachments = ((mm_not_null($this->attachments)) ? true : false);
      $html_images = ((mm_not_null($this->html_images)) ? true : false);
      $html = ((mm_not_null($this->html)) ? true : false);
      $text = ((mm_not_null($this->text)) ? true : false);
